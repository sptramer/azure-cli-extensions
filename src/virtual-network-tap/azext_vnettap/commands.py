...
from ._client_factory import cf_virtual_network_taps, cf_nics, cf_nic_tap_config, cf_load_balancers
...
def load_command_table(self, _):
    ...
    network_lb_sdk = CliCommandType(
        operations_tmpl='azext_vnettap.vendored_sdks.operations.load_balancers_operations#LoadBalancersOperations.{}',
        client_factory=cf_load_balancers
    )

    network_nic_sdk = CliCommandType(
        operations_tmpl='azext_vnettap.vendored_sdks.operations.network_interfaces_operations#NetworkInterfacesOperations.{}',
        client_factory=cf_nics
    )
    ...
    with self.command_group('network nic vtap-config', network_nic_sdk) as g:
